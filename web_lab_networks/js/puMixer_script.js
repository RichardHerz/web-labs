...
class Mixer {
    ...
    constructor(unitCount, unitID, sceneX, sceneY, params) {
        ...
        const fieldID= "mixer_num_" + this.unitCount;
    ...
    initialize() {
        console.log('enter class Mixer initialize method');
        console.log('  this class unitID = ' + this.unitID);
        console.log('  this.unitCount = ' + this.unitCount);
    } // END OF FUNCTION initialize 

    reportInputStatus() {
        // console.log('---- enter reportInputStatus in Mixer ----');
        ...
        // console.log('---- exit reportInputStatus in Mixer ----');
    } // END OF FUNCTION reportInputStatus

    updateInputs() {
        console.log('enter class Mixer updateInputs method');
        console.log('  this class unitID = ' + this.unitID);
        console.log('  this.unitCount = ' + this.unitCount);
        ...
        Object.keys(this.portData.inputs).forEach(inputKey => {
            ...
            const inputID = "mixer_input_" + inputKey + '_' + this.unitCount;
            ...
            if (portInUnitIndex == -1) {
                ...
                // in "mixer_outputs_one_${zz}" want item [2] 
        ...
        console.log('just before end of upateInputs in Mixer');
        this.reportInputStatus();
        console.log('end of upateInputs in Mixer');

    } // END OF updateInputs()

    updateState() {

        console.log('enter class Mixer updateState method');
    ...
    //    console.log('  inMIXEDconc = ' + inMIXEDconc);
        ...
        // if (vol == 0) {
        //     console.log('ERROR mixer volume = 0 will get div by zero');
        // }

        const cnew = inMIXEDconc;
        ...
        // want to update innerHTML text displayed in div id="mixer_info_${zz}"
        const el = document.getElementById('mixer_info_' + this.unitCount); 

        const thisConc = cnew;
        const thisFlow = totalINflow;
        
        console.log('  mixer thisConc = ' + thisConc);
        console.log('  mixer flowrate = ' + thisFlow);

        const roundedConc = Math.round(thisConc * 100) / 100;
        const roundedFlow = Math.round(thisFlow * 100) / 100;

        console.log('  mixer roundedConc = ' + roundedConc);
        console.log('  mixer flowrate = ' + roundedFlow);
        ...
        console.log('end of updateState in Mixer');
