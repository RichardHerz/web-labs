...
let plotInfo = {
  ...
  initialize : function() {
    ...
    plotInfo[pnum]['title'] = 'Spirit Still';
    ...
    let npts = 250; // WARNING: npts used in two places below
    ...
    plotInfo[pnum]['yLeftAxisLabel'] = 'mol fraction';
    plotInfo[pnum]['yLeftAxisMin'] = 0;
    plotInfo[pnum]['yLeftAxisMax'] = 1;
    plotInfo[pnum]['yRightAxisLabel'] = 'Temperature (°C)';
    plotInfo[pnum]['yRightAxisMin'] = 20;
    plotInfo[pnum]['yRightAxisMax'] = 100;
    ...
    plotInfo[pnum]['plotDataSeriesColors'] = ['Green','Blue','Black','Red','Tin','Orange']; // optional, in variable order 0, 1, etc.
    ...
    plotInfo[pnum]['varUnitIndex'][vnum] = unum; // value is index of unit in processUnits object
    plotInfo[pnum]['var'][vnum] = vnum; // value is variable index in plot data array
    plotInfo[pnum]['varLabel'][vnum] = 'y2';
    plotInfo[pnum]['varDataUnits'][vnum] = ''; // processUnits[1]['dataUnits'][4]; // 1st var
    plotInfo[pnum]['varShow'][vnum] = 'show';
    plotInfo[pnum]['varYaxis'][vnum] = 'left';
    plotInfo[pnum]['varYscaleFactor'][vnum] = 1;
    ...
    plotInfo[pnum]['varUnitIndex'][vnum] = unum; // value is index of unit in processUnits object
    plotInfo[pnum]['var'][vnum] = vnum; // value is variable index in plot data array
    plotInfo[pnum]['varLabel'][vnum] = 'T';
    plotInfo[pnum]['varDataUnits'][vnum] = '°C'; // processUnits[1]['dataUnits'][4]; // 1st var
    plotInfo[pnum]['varShow'][vnum] = 'hide';
    ...
    plotInfo[pnum]['varUnitIndex'][vnum] = unum; // value is index of unit in processUnits object
    plotInfo[pnum]['var'][vnum] = vnum; // value is variable index in plot data array
    plotInfo[pnum]['varLabel'][vnum] = 'T2';
    plotInfo[pnum]['varDataUnits'][vnum] = '°C'; // processUnits[1]['dataUnits'][4]; // 1st var
    plotInfo[pnum]['varShow'][vnum] = 'show';
    plotInfo[pnum]['varYaxis'][vnum] = 'right';
    plotInfo[pnum]['varYscaleFactor'][vnum] = 1;
