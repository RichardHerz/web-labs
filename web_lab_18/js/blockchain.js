...
let data = {
  ...
  initialize : function() {
    ...
    data['header'] = '';
    // get names from http://www.studentsoftheworld.info/penpals/stats.php?Pays=ZIM
    data['people'] = new Object();
    data['people'][0] = 'Priya'; // India
    data['people'][1] = 'Tinashe'; // Africa
    data['people'][2] = 'Lily'; // Asia
    data['people'][3] = 'Zahra'; // Middle East
    data['people'][4] = 'Luca'; // Europe
