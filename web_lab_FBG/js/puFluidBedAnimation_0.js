...
let puFluidBedAnimation_0 = {
  //
  unitIndex : 0, // index of this unit as child in processUnits parent object
  // unitIndex used in this object's updateUIparams() method
  name : 'Bed 0 Animation',

  plotIndex : 0, // see process_plot_info.js
  ...
  initialize() {
    ...
    for (i = 0; i < this.N; i += 1) {
      ...
      this.ants[i] = new Particle_0(xi,yi,dx,dy);
    }
...
class Particle_0 {
  ...
  move() {
    ...
    let ynew = this.y + this.dy + 10 * Math.random();
    // bounce if hit walls
...
} // END OF class Particle_0 definition
