...
let simParams = {
  ...
  title : 'PFR - Plug Flow Reactor - isothermal, nth order reaction', // title of simulation
  ...
  updateRunCount : function() {
    ...
    if (controller.simTime < 2) {
      $.post(this.runLoggerURL,{webAppNumber: "15, PFR reactor, isothermal, nth order reaction"})
        .done(
          function(data) {
