    ...
    if (zz == 0) {
        ...
        buildText += ` 
            <div id="splitter_${zz}" class="splitter" 
                onclick="main.paletteObjectClicked(event, 'splitter' )" > 
