function puCSTR(pUnitIndex) {
  ...
  this.getRxnRate = function(conc) {
    ...
    // Web Labs, Lab 2, reaction-diffusion at default lab entry conditions
  ...
  this.updateState = function() {
    ...
    let Kflow = 0.0050; // = Kflow in Lab 2 = Q/Vp/k-1 = (Q/Vc)*(Vc/Vp)/k-1
    // default Kflow in Lab 2 is 0.04
    // XXX check to make sure SS conversions in Lab 2 and 9 agree with this difference
