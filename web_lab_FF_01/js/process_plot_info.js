...
let plotInfo = {
  ...
  initialize() {
    ...
    plotInfo[pnum]['title'] = 'Forest';
    plotInfo[pnum]['canvas'] = 'canvas_CANVAS_forest'; // without prefix #
    ...
    plotInfo[pnum]['varValueMin'] = 300; // processUnits[unum]['dataMin'][1];
    plotInfo[pnum]['varValueMax'] = 1000;
    //
